...
fr_index = LabelFrame(root).grid()

welcome = Label(fr_index, text='Bem vindo ao sistema',
                bg="#00c", fg='#fff', font='Roboto 20')
welcome.grid(row=0, column=0, columnspan=3, padx=110, pady=55)
start = Button(fr_index, text="Iniciar", width=15,font='roboto 15', command=lambda: [
               remove(start), remove_lb(welcome), fr0.grid(row=0, column=0)])
...
cadastrar_pr = Button(fr1, text="Cadasstrar Produto", command=lambda: [
                      fr1.grid_remove(), fr1_1.grid(row=0, column=0)])
cadastrar_pr.grid(row=0, column=0)

delete_pr = Button(fr1, text='Deletar Produto', command=lambda: [
                   fr1.grid_remove(), fr1_2.grid(row=0, column=0)])
delete_pr.grid(row=0, column=1)

listar_fr1 = Button(fr1, text='listar', command=lambda: [
                    fr1.grid_remove(), fr1_3.grid(row=0, column=0)])
listar_fr1.grid(row=0, column=2)

alterar_fr1 = Button(fr1, text='Alterar', command=lambda: [
                     fr1.grid_remove(), fr1_4.grid(row=0, column=0)])
alterar_fr1.grid(row=0, column=3)

voltar = Button(fr1, text='voltar', command=lambda: [
                fr1.grid_remove(), fr0.grid(row=0, column=0)])
...
voltar_fr1_1 = Button(fr1_1, text='voltar', command=lambda: [
                      fr1_1.grid_remove(), fr1.grid(row=0, column=0)])
voltar_fr1_1.grid()
...
voltar_fr1_2 = Button(fr1_2, text='voltar', command=lambda: [
                      fr1_2.grid_remove(), fr1.grid(row=0, column=0)])
voltar_fr1_2.grid()
...
voltar_fr1_3 = Button(fr1_3, text='voltar', command=lambda: [
                      fr1_3.grid_remove(), fr1.grid(row=0, column=0)])
voltar_fr1_3.grid()
...
voltar_fr1_4 = Button(fr1_4, text='voltar', command=lambda: [
                      fr1_4.grid_remove(), fr1.grid(row=0, column=0)])
voltar_fr1_4.grid()
...
cadastrar_pr = Button(fr2, text="Cadastrar Fabricante", command=lambda: [
                      fr2.grid_remove(), fr2_1.grid(row=0, column=0)])
cadastrar_pr.grid(row=0, column=0)

delete_pr = Button(fr2, text='Deletar Fabricante', command=lambda: [
                   fr2.grid_remove(), fr2_2.grid(row=0, column=0)])
delete_pr.grid(row=0, column=1)

listar_fr1 = Button(fr2, text='listar', command=lambda: [
                    fr2.grid_remove(), fr2_3.grid(row=0, column=0)])
listar_fr1.grid(row=0, column=2)

alterar_fr1 = Button(fr2, text='Alterar', command=lambda: [
                     fr2.grid_remove(), fr2_4.grid(row=0, column=0)])
alterar_fr1.grid(row=0, column=3)

voltar = Button(fr2, text='voltar', command=lambda: [
                fr2.grid_remove(), fr0.grid(row=0, column=0)])
voltar.grid(row=0, column=4)
...
voltar_fr2_1 = Button(fr2_1, text='voltar', command=lambda: [
                      fr2_1.grid_remove(), fr2.grid(row=0, column=0)])
voltar_fr2_1.grid()
...
voltar_fr2_2 = Button(fr2_2, text='voltar', command=lambda: [
                      fr2_2.grid_remove(), fr2.grid(row=0, column=0)])
voltar_fr2_2.grid()
...
voltar_fr2_3 = Button(fr2_3, text='voltar', command=lambda: [
                      fr2_3.grid_remove(), fr2.grid(row=0, column=0)])
voltar_fr2_3.grid()
...
voltar_fr2_4 = Button(fr2_4, text='voltar', command=lambda: [
                      fr2_4.grid_remove(), fr2.grid(row=0, column=0)])
voltar_fr2_4.grid()
